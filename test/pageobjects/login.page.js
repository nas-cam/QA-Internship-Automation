...
class LoginPage extends Page {
    ...
    get btnAddToCart() {
        return $('.single_add_to_cart_button.button.alt.wp-element-button');
    }
    get btnViewCart() {
        return $('a.button.wc-forward.wp-element-button');
    }
    get tblCart() {
        return $('.shop_table.shop_table_responsive.cart');
    }
    get btnProceedToCheckout() {
        return $('.checkout-button.button.alt.wc-forward.wp-element-button');
    }
    get inputFirstName() {
